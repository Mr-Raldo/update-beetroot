...
from .register.views import RegisterView, CreateProfileViewSet
from .login.views import LoginView, SigninViewSet
...
router.register(r'profiles', CreateProfileViewSet)
router.register(r'profile-signin', SigninViewSet)
